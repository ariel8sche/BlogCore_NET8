...
namespace BlogCore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            // Campos personalizados, los mismo del application user
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Con esto guardamos los campos personalizados
                ...
                if (result.Succeeded)
                {
                    // Aquí se asigna los roles existentes al nuevo usuario
                    ...
                    string rolSeleccionado = Request.Form["radUsuarioRole"].ToString();

                    // Validamos si el rol seleccionado es "Administrador" y si es lo agregamos
                    if (rolSeleccionado == CNT.Administrador)
                    {
                        await _userManager.AddToRoleAsync(user, CNT.Administrador);
                    }
                    else
                    {
                        if (rolSeleccionado == CNT.Registrado)
                        {
